...
int main()
{
    ...
    // -------------------------
    Shader shaderGeometryPass("../shader/deferred/g_buffer.vs", "../shader/deferred/g_buffer.fs");
    Shader shaderLightingPass("../shader/deferred/deferred_light.vs", "../shader/deferred/deferred_light.fs");
    Shader shaderLightBox("../shader/deferred/deferred_shading.vs", "../shader/deferred/deferred_shading.fs");

    Shader debugShader("../shader/debug/debug.vs", "../shader/debug/debug.fs");
