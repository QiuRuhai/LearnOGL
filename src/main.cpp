...
int main()
{
    ...
    // -------------------------
    Shader shader("../shader/parallax/parallax.vs", "../shader/parallax/parallax.fs");

    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture("../resources/texture/bricks2.jpg");
    unsigned int normalMap  = loadTexture("../resources/texture/bricks2_normal.jpg");
    unsigned int heightMap  = loadTexture("../resources/texture/bricks2_disp.jpg");
